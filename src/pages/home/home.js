    ...
    <div className="container-fluid">
      <div className="row header">
        ...
        <div className="col-md-9 navbar text-decoration-none ">
          ...
          <strong>
            <a href="#Hospital" className="text-decoration-none">
              Hospital
            </a>
          </strong>
          <strong>
            <a href="#Doctor" className="text-decoration-none">
              Doctor
            </a>
          </strong>
          <strong>
            <a href="#Department" className="text-decoration-none">
              Department
            </a>
          </strong>
          <strong>
      ...
      <div className="row">
        <div className="column bg">
          ...
          <div className="row">
            ...
            <button type="button" className="btn btn-light btn-lg2">
              book an Appoinment
            </button>
          </div>
        </div>
      ...
      <div className="row">
        <div className="column box d-flex mb-3">
          <div className="boxes p-2 m-2 flex-fill">Primary Care</div>
          <div className="boxes p-2 m-2  flex-fill">Emergrncy cases</div>
          <div className="boxes p-2 m-2  flex-fill">Online Appoinment</div>
        </div>
      </div>
